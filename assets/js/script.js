...
const deleteItem = new Audio("./assets/sounds/delete-item.mp3");
...
headerTime.textContent = `${weekDayName}, ${monthOfDay} de ${monthName}`;
...
const removeTask = function () {
  ...
  if (this.dataset.taskRemove === "complete") {
    ...
    parentElement.remove(); // remove taskItem
    deleteItem.play(); // play deleteItemSound
